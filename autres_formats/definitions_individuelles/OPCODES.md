...
> ► *« Opcode » peut être traduit en français par « code opératoire ». Dans la pratique, on utilise directement le terme « opcode » dans le langage courant. Pour plus d'informations, voir les définitions de **[PILE](/dictionnaire/P.md#pile)** et **[SCRIPT](/dictionnaire/S.md#script)**.*
