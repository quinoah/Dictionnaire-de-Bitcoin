...
> ► *Pour plus d'informations, voir la définition de [**OP_CHECKLOCKTIMEVERIFY (0XB1)**](/dictionnaire/O.md#op_checklocktimeverify-0xb1) et [**TIMELOCK**](/dictionnaire/T.md#timelock).*
