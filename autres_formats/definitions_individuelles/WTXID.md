...
> ► *Pour plus d'informations, voir la définition de [**TXID (TRANSACTION IDENTIFIER)**](/dictionnaire/T.md#txid-transaction-identifier) et [**SEGWIT**](/dictionnaire/S.md#segwit).*
