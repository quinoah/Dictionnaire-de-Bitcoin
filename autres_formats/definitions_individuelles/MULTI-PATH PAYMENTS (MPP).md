...
> ► *On parle également parfois de « Multi-Part Payment » pour désigner cette même méthode. Pour plus d'informations, voir la définition de **[ATOMIC MULTI-PATH PAYMENTS](/dictionnaire/A.md#atomic-multi-path-payments)**.*
