...
> ► *L'algorithme de preuve de travail (Proof-of-Work ou PoW) utilisé par Bitcoin est un mécanisme de consensus dit « Tolérant aux pannes byzantines » ou « Byzantine Fault Tolerant (BFT) ». Pour plus d'informations, voir la définition de **[PROB. DES GÉNÉRAUX BYZANTINS](/dictionnaire/P.md#prob.-des-généraux-byzantins)**.*
