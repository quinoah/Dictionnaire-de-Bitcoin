...
> ► *Pour plus d'informations, voir la définition de [**OP_CHECKSEQUENCEVERIFY (0XB2)**](/dictionnaire/O.md#op_checksequenceverify-0xb2) et [**TIMELOCK**](/dictionnaire/T.md#timelock).*
