...
Omni Layer (ex-Mastercoin) est une plateforme open-source et décentralisée de création d'actifs sur la blockchain Bitcoin. Parmi les actifs sur Omni on peut citer Tether (USDT) et MaidSafeCoin (MAID).
